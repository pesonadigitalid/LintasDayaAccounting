...
<?php include "pages/header.php"; ?>
    <section class="section section-body bg-grey">
        <section id="overview" class="grid-hero container">
            <div class="col-sm-7">
                <h5>Laporan Jurnal<small>Laporan jurnal umum dan transaksi</small></h5>
                <?php if(isset($notif)){ ?>
                ...
                <form method="GET" action="<?php echo PRSONPATH; ?>print-jurnal/" class="form-horizontal form-bordered">
