...
$proyekList = explode(",", $this->validasi->validInput($_GET['proyek']));
...
$periode = "Periode Laporan: " . $tanggalID;

$db =  new ezSQL_mysql(YGDBUSER, YGDBPASS, YGDBNAME, YGDBHOST);

$totalProyek = count($proyekList);
?>
<!DOCTYPE HTML>
<html>
...
<body class="center">
    <?php
    if ($totalProyek == 0) echo "Tidak ada proyek yang dipilih";
    else {
        $limit = 10;
        $TotalAll = array();
    ...
    ?>
            <div class="newPage">
                <?php if ($tipe == "1") { ?>
                    <h1 class="blue">Proyeksi Proyek</h1>
                    ...
                    <table class="tbLabaRugi" style="width: auto">
                        ...
                        <tr>
                            ...
                            $projectIds = implode(",", array_slice($proyekList, $start, $limit));

                            $query = newQuery("get_results", "SELECT * FROM tb_proyek WHERE IDProyek IN ($projectIds) ORDER BY KodeProyek ASC");
                            if ($query) {
                                foreach ($query as $data) {
                            ?>
                                    <td width="90" style="text-align: center;border-bottom: solid 1px #333;padding-bottom: 5px;"><?php echo $data->NamaProyek; ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: right;"><?php echo number_format($material1, 2); ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: right;"><?php echo number_format($pengiriman1, 2); ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: center;text-align:right;"><?php echo number_format($overhead1, 2); ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: center;text-align:right;border-bottom: solid 1px #333;padding-bottom: 5px;"><?php echo number_format($accidental1, 2); ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: center;text-align:right;border-bottom: solid 1px #333;padding-bottom: 5px;font-weight: bold;"><?php echo number_format($totalPengeluaran, 2); ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: center;text-align:right;border-bottom: solid 1px #333;padding-bottom: 5px;"><?php echo number_format($return1, 2); ?></td>
                            <?php
                        ...
                        <tr>
                            ...
                            ?>
                                <td style="text-align: center;text-align:right;border-bottom: solid 1px #333;padding-bottom: 5px;font-weight: bold;"><?php echo number_format($labaRugi, 2); ?></td>
                            <?php
