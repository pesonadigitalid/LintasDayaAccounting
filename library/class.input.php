...
class InputForm
{
    ...
    function inputTextArea($name,$class,$value="",$row="",$col="",$placeholder="",$helper="",$helper_class="",$additional=""){
        echo "<textarea name='".$name."' id='".$name."' class='".$class."' rows='".$row."' cols='".$col."' placeholder='".$placeholder."' ".$additional.">".$value."</textarea>";
        if($helper!="")
            echo "<span class='".$helper_class."'>".$helper."</span>";
    }
}
